...
# python3 ../../../utils/HDF5merger.py data/output/SK data/output/SK/combined.hdf5
python3 ../../../utils/HDF5merger.py data/output/SK_Htag data/output/SK_Htag/combined.hdf5
python3 ../../../utils/HDF5merger.py data/output/SK_Gdtag data/output/SK_Gdtag/combined.hdf5

# Re-weighting after combination
# python3 ammendWeight.py data/output/SK/combined.hdf5
python3 ammendWeightNtag.py data/output/SK_Htag/combined.hdf5
python3 ammendWeightNtag.py data/output/SK_Gdtag/combined.hdf5
