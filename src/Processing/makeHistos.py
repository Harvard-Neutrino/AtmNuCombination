...
axis[2].hist(np.log10(pnu[(itype==14)]) ,50, weights=oscw[(itype==14)], ec='red', fc='none')
axis[2].hist(np.log10(pnu[(itype==15)]) ,50, weights=oscw[(itype==15)], ec='blue', fc='none')
axis[2].legend(labels = ('PC Stop', 'PC Thru'), loc = 'upper right')

axis[3].hist(np.log10(pnu[(itype==16)]) ,50, weights=oscw[(itype==16)], ec='red', fc='none')
axis[3].hist(np.log10(pnu[(itype==17)]) ,50, weights=oscw[(itype==17)], ec='blue', fc='none')
axis[3].hist(np.log10(pnu[(itype==18)]) ,50, weights=oscw[(itype==18)], ec='green', fc='none')
